  ...
  if (ArmPlatformIsPrimaryCore (MpId))
  {
    ...
    // Configure pins 30-39 (GPFSEL3)
    {
      ...
      const UINT32 functionMask =
        ...
        (GPIO_FSEL_ALT5 << (32 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |   // UART1_TX
        (GPIO_FSEL_ALT5 << (33 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |   // UART1_RX
